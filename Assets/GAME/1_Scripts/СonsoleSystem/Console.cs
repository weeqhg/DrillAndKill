...
public class Console : UIWindow
{
    ...
    private void RegisterCommands()
    {
        ...
        _commands.Add("spawn_pepelats", CommandLaunchPepelats);
    ...
    private void Help(string[] args)
    {
            ...
            _helpMessages = new List<string>
        {
            ...
            "spawn_pepelats - Boer launch on world",
    ...
    private void CommandLaunchPepelats(string[] args)
    {
        ConsoleEvents.CommandLaunchPepelats();
    }

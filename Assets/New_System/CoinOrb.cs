...
public class CoinOrb : MonoBehaviour, ICollectable
{
    ...
    private void AttractNearbyOrbs()
    {
        ...
        {
            CoinOrb orb = hit.GetComponent<CoinOrb>();
    ...
    private void Collect()
    {
        ...
        moneyManager.AddCoin(coinAmount);

        PoolManager.Instance.Return(PoolId.CoinOrb, gameObject);
    }

...
public class DifficultyManager : MonoBehaviour
{
    ...
    {
        GameEvents.OnEntityDie += RegisterKill;
        GameEvents.OnDamageDealt += RegisterDamageDealt;
        GameEvents.OnDamageTaken += RegisterDamageTaken;
    ...
    public void RegisterDamageDealt(float value) => damageDealt += value;

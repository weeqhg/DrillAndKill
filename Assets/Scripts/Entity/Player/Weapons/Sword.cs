...
public class Sword : MonoBehaviour
{
    ...
    public void Initialize(CameraShake cameraShake, StatsController statsController)
    {
        ...
        _inputManager.Actions.Player.Shoot.started += ctx => isAttackingInput = true;
        _inputManager.Actions.Player.Shoot.canceled += ctx => isAttackingInput = false;
    }
    ...
    private void UpdateStats()
    {
        ...
        attackRadius = stats.GetStat(StatType.MeleeRange);
    }
